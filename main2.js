...
function startApp() {
    ...
    */
    ...
    exportButton.addEventListener ('mouseup', function() {
        exportButton.style.backgroundColor = 'rgb(69, 150, 69)'; // Restore original background color after click
    });
    ...
    exportButton.addEventListener('click', () => {
        ...
        for (let i = 0; i < boolean_mesh_list.length; i++) {
            ...
            meshesToExport.push(boolean_mesh_list[i]);   // Array of meshes to export
